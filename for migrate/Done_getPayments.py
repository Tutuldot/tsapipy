...
req2.path = "/finance/202309/payments"
req2.query = "app_key=6b57ikn775gaj&sort_field=create_time&timestamp=" + str(ts) + "&shop_cipher=ROW_PH68hwAAAADLEA37wZU4K8LufewN_8Gr" 
...
f_url = url + "?app_key=6b57ikn775gaj&sort_field=create_time&shop_cipher=ROW_PH68hwAAAADLEA37wZU4K8LufewN_8Gr&timestamp=" + str(ts) + "&sign=" + signature 
print(f_url)
